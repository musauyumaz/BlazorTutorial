...
namespace Application.Features.Commands.Orders.Delete;

public record DeleteOrderCommandRequest(string Id) : IRequest<IDataResult<OrderDTO>>;
public class DeleteOrderCommandHandler(IOrderRepository _orderRepository) : IRequestHandler<DeleteOrderCommandRequest, IDataResult<OrderDTO>>
{
