...
public class GetByIdSupplierQueryHandler(IBaseRepository<Supplier> _supplierRepository) : IRequestHandler<GetByIdSupplierRequest, IDataResult<GetByIdSupplierResponse>>
{
